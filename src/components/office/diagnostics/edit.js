...
const DiagnosticsEdit = (props) => {
  ...
  const sections = useSelector((store) => store.sections.data);
  ...
  const [quiz, setQuiz] = useState(
    state?.quiz ? { ...state.quiz, section: state.quiz.section._id } : newQuiz
  );
              ...
              <div className="input-group">
                ...
                <Select
                  ...
                  changeHandler={(selectedOption) =>
                    changeInput("section", selectedOption._id)
                  }
                  value={
                    sectionOptions.find((s) => s._id === quiz.section)?.name
                  }
                />
              </div>
              <div className="input-group">
